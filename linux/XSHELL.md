...
sermod -u 1024 -g group2 -G root rainger`

将 rainger用户 uid 修改为 1024，默认组改为系统中已经存在的 rainger，并且加入到系统管理员组

### [#](https://www.funtl.com/zh/linux/Linux-用户和组管理.html#删除用户)删除用户
...
删除用户名为 rainger 的账户并同时删除 rainger 的用户目录
