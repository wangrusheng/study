...
![img](nginx-introduce.assets/5-1261206014.png)

客户端必须设置正向代理服务器，当然前提是要知道正向代理服务器的IP地址，还有代理程序的端口。如图。

![img](nginx-introduce.assets/4-1910765480.png)
...
![img](nginx-introduce.assets/73-925019958.png)
...
![img](nginx-introduce.assets/2-1246060303.png)

**二者区别**

截了一张图来说明正向代理和反向代理二者之间的区别，如图。

![img](nginx-introduce.assets/97-940664368.png)
...
![img](nginx-introduce.assets/61-333776342.png)
...
![img](nginx-introduce.assets/6-1252546625.png)
